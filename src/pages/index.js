      ...
      <Box sx={{ display: "flex" }}>
        ...
        >
          <Seo
            title={
              serverId === "lasersword"
                ? "Laser Sword | Official Website"
                : "Fall to Your Death | Official Website"
            }
            description={
              serverId === "lasersword"
            ...
            image={
              serverId === "lasersword"
                ? "/static/images/lasersword.jpg"
                : "/static/images/ftyd.jpg"
            }
            article={false}
          />
          <TypeWriter
          ...
          {!chivSteamBrowser ? (
            ...
            >
              ...
              {serverId === "lasersword" ? "Laser Sword" : "Fall to Your Death"}{" "}
              server
            </Typography>
          ) : (
            <Typography
          ...
          <Carousel interval={8000} stopAutoPlayOnHover={false}>
            {items.map((item, i) => {
              ...
              if (i === 0) {
                bgStyle = {
                  background:
                    "linear-gradient(45deg, #FFD700, #FFEC8B, #FFD700)",
                  backgroundSize: "200% 100%",
                ...
                bgStyle = {
                  background:
                    "linear-gradient(45deg, #CD7F32, #B87333, #CD7F32)",
                  backgroundSize: "200% 100%",
                ...
                bgStyle = {
                  backgroundImage:
                    "url('http://clipart-library.com/images_k/blue-flame-transparent-background/blue-flame-transparent-background-13.png')",
                ...
                >
                  ...
                  >
                    ...
                    <Typography variant={notMobile ? "h5" : "body1"}>
                      {serverId === "lasersword" ? "Score" : "Kills"}:{" "}
                      {item.kills}
                    </Typography>
                  </Box>
                </Paper>
